...
export class FirstInit1682404967528 implements MigrationInterface {
  name = 'FirstInit1682404967528';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "token" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "type" "public"."token_type_enum" NOT NULL, "expired" boolean NOT NULL, "revoked" boolean NOT NULL, "ipAddress" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL, "userId" integer, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
